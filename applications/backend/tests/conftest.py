...
def summary_format_list_factory():
    def _summary_format_list_factory(
        summary_format_list: list[str] = sample_summary_format_list,
    ) -> list[str]:
...
def summary_input_factory():
    def _summary_input_factory(
        summary_format: str, openai_key: str = sample_openai_key
    ) -> dict[str, str]:
        return {"openai_key": openai_key, "summary_format": summary_format}
