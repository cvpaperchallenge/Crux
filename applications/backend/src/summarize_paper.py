...
from src.dto import FormatNormal, FormatThreePoint, FormatOchiai, FormatCVPaper
...
class SummarizeHandler:    
    ...
    def three_point_summary(self, parsed_pdf: dict, openai_key: SecretStr) -> FormatThreePoint:
