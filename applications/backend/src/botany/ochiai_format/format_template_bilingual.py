...
Output: """
OCHI_METHOD_TEMPLATE = """Write up to a 100-word summary of the proposed method of this study from the following statement IN JAPANESE:
...
Output IN JAPANESE: """
OCHI_EVAL_TEMPLATE = """Write up to a 100-word summary of the evaluation methodology of the proposed method from the following statement IN JAPANESE:
...
Output IN JAPANESE: """
OCHI_DISCUSSION_TEMPLATE = """Write up to a 100-word summary of how authors provide insight into the evaluation results from the following statements IN JAPANESE:
